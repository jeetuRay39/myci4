  ...
  <main>
    <div class="card-body">
        <form action="<?= base_url('students/add') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-2">
                <label >Phone</label>
                <input type="text" name="phone" class="form-control" placeholder="enter your phonenumber" Required>
            </div>
            <div class="form-group mb-2">
                <label >course</label>
            ...
            <div class="form-group">
            <a href="<?=base_url('/students') ?>" class="btn btn-primary btn-sm mt-2">Back</a>
            </div>
